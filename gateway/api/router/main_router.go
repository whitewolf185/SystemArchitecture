...
import (
	...
	custommiddleware "github.com/whitewolf185/SystemArchitecture/gateway/api/middleware"
	_ "github.com/whitewolf185/SystemArchitecture/gateway/docs"
...
func NewRouter(
	...
	root.Mount("/gateway", newDomainRouter(errHandler))
