...
type personsTable struct {
	...
	UserPassword postgres.ColumnString
	IsDriver     postgres.ColumnBool
...
func newPersonsTableImpl(schemaName, tableName, alias string) personsTable {
	var (
		...
		UserPasswordColumn = postgres.StringColumn("user_password")
		IsDriverColumn     = postgres.BoolColumn("is_driver")
		allColumns         = postgres.ColumnList{IDColumn, UsernameColumn, UserPasswordColumn, IsDriverColumn}
		mutableColumns     = postgres.ColumnList{UsernameColumn, UserPasswordColumn, IsDriverColumn}
	)
	...
	return personsTable{
		...
		UserPassword: UserPasswordColumn,
		IsDriver:     IsDriverColumn,
